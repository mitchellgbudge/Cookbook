...
class RecipesTableViewController: UITableViewController {
    ...
    lazy var fetchedResultsController: NSFetchedResultsController<Recipe> = {
        ...
        let frc = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: CoreDataStack.shared.mainContext, sectionNameKeyPath: "cuisine", cacheName: nil)
        frc.delegate = self
        do {
